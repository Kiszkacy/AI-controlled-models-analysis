...
public readonly struct AgentData
{
    ...
    public AgentData Normalize(Agent agent)
    {
        return new AgentData(
            ...
            distanceToClosestFood: Mathf.Remap(float.IsNaN(this.DistanceToClosestFood) ? (float)1.05 * agent.SightRadius : this.DistanceToClosestFood, 0.0f, agent.SightRadius, -1, 1),
